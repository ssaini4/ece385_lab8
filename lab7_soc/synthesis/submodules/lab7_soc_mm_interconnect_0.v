...
// 
// Generated using ACDS version 14.0 200 at 2015.10.17.20:28:37
...
module lab7_soc_mm_interconnect_0 (
	...
	wire          cmd_mux_005_src_endofpacket;                                                        // cmd_mux_005:src_endofpacket -> reset_s1_agent:cp_endofpacket
	wire          cmd_mux_005_src_valid;                                                              // cmd_mux_005:src_valid -> reset_s1_agent:cp_valid
	wire          cmd_mux_005_src_startofpacket;                                                      // cmd_mux_005:src_startofpacket -> reset_s1_agent:cp_startofpacket
	wire  [106:0] cmd_mux_005_src_data;                                                               // cmd_mux_005:src_data -> reset_s1_agent:cp_data
	wire   [13:0] cmd_mux_005_src_channel;                                                            // cmd_mux_005:src_channel -> reset_s1_agent:cp_channel
	wire          cmd_mux_005_src_ready;                                                              // reset_s1_agent:cp_ready -> cmd_mux_005:src_ready
	...
	wire          accumulate_s1_agent_rdata_fifo_src_valid;                                           // accumulate_s1_agent:rdata_fifo_src_valid -> accumulate_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] accumulate_s1_agent_rdata_fifo_src_data;                                            // accumulate_s1_agent:rdata_fifo_src_data -> accumulate_s1_agent:rdata_fifo_sink_data
	wire          accumulate_s1_agent_rdata_fifo_src_ready;                                           // accumulate_s1_agent:rdata_fifo_sink_ready -> accumulate_s1_agent:rdata_fifo_src_ready
	...
	wire          cmd_mux_007_src_endofpacket;                                                        // cmd_mux_007:src_endofpacket -> jtag_uart_0_avalon_jtag_slave_agent:cp_endofpacket
	wire          cmd_mux_007_src_valid;                                                              // cmd_mux_007:src_valid -> jtag_uart_0_avalon_jtag_slave_agent:cp_valid
	wire          cmd_mux_007_src_startofpacket;                                                      // cmd_mux_007:src_startofpacket -> jtag_uart_0_avalon_jtag_slave_agent:cp_startofpacket
	wire  [106:0] cmd_mux_007_src_data;                                                               // cmd_mux_007:src_data -> jtag_uart_0_avalon_jtag_slave_agent:cp_data
	wire   [13:0] cmd_mux_007_src_channel;                                                            // cmd_mux_007:src_channel -> jtag_uart_0_avalon_jtag_slave_agent:cp_channel
	wire          cmd_mux_007_src_ready;                                                              // jtag_uart_0_avalon_jtag_slave_agent:cp_ready -> cmd_mux_007:src_ready
	...
	wire          reset_s1_agent_rp_endofpacket;                                                      // reset_s1_agent:rp_endofpacket -> router_007:sink_endofpacket
	wire          reset_s1_agent_rp_valid;                                                            // reset_s1_agent:rp_valid -> router_007:sink_valid
	wire          reset_s1_agent_rp_startofpacket;                                                    // reset_s1_agent:rp_startofpacket -> router_007:sink_startofpacket
	wire  [106:0] reset_s1_agent_rp_data;                                                             // reset_s1_agent:rp_data -> router_007:sink_data
	wire          reset_s1_agent_rp_ready;                                                            // router_007:sink_ready -> reset_s1_agent:rp_ready
	...
	wire  [106:0] jtag_uart_0_avalon_jtag_slave_agent_rp_data;                                        // jtag_uart_0_avalon_jtag_slave_agent:rp_data -> router_009:sink_data
	...
	altera_merlin_slave_agent #(
		...
		.rdata_fifo_sink_ready   (accumulate_s1_agent_rdata_fifo_src_ready),       // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (accumulate_s1_agent_rdata_fifo_src_valid),       //                .valid
		.rdata_fifo_sink_data    (accumulate_s1_agent_rdata_fifo_src_data),        //                .data
	...
	lab7_soc_mm_interconnect_0_router_007 router_014 (
	...
	lab7_soc_mm_interconnect_0_router_007 router_015 (
	...
	lab7_soc_mm_interconnect_0_cmd_mux_005 cmd_mux_012 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab7_soc_mm_interconnect_0_cmd_mux_005 cmd_mux_013 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab7_soc_mm_interconnect_0_rsp_demux_005 rsp_demux_012 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab7_soc_mm_interconnect_0_rsp_demux_005 rsp_demux_013 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
