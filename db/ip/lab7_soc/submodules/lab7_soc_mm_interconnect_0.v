...
module lab7_soc_mm_interconnect_0 (
		...
		output wire [1:0]  reset_button_s1_address,                          //                            reset_button_s1.address
		input  wire [31:0] reset_button_s1_readdata,                         //                                           .readdata
	...
	wire   [31:0] reset_button_s1_agent_m0_readdata;                                                  // reset_button_s1_translator:uav_readdata -> reset_button_s1_agent:m0_readdata
	wire          reset_button_s1_agent_m0_waitrequest;                                               // reset_button_s1_translator:uav_waitrequest -> reset_button_s1_agent:m0_waitrequest
	wire          reset_button_s1_agent_m0_debugaccess;                                               // reset_button_s1_agent:m0_debugaccess -> reset_button_s1_translator:uav_debugaccess
	wire   [28:0] reset_button_s1_agent_m0_address;                                                   // reset_button_s1_agent:m0_address -> reset_button_s1_translator:uav_address
	wire    [3:0] reset_button_s1_agent_m0_byteenable;                                                // reset_button_s1_agent:m0_byteenable -> reset_button_s1_translator:uav_byteenable
	wire          reset_button_s1_agent_m0_read;                                                      // reset_button_s1_agent:m0_read -> reset_button_s1_translator:uav_read
	wire          reset_button_s1_agent_m0_readdatavalid;                                             // reset_button_s1_translator:uav_readdatavalid -> reset_button_s1_agent:m0_readdatavalid
	wire          reset_button_s1_agent_m0_lock;                                                      // reset_button_s1_agent:m0_lock -> reset_button_s1_translator:uav_lock
	wire   [31:0] reset_button_s1_agent_m0_writedata;                                                 // reset_button_s1_agent:m0_writedata -> reset_button_s1_translator:uav_writedata
	wire          reset_button_s1_agent_m0_write;                                                     // reset_button_s1_agent:m0_write -> reset_button_s1_translator:uav_write
	wire    [2:0] reset_button_s1_agent_m0_burstcount;                                                // reset_button_s1_agent:m0_burstcount -> reset_button_s1_translator:uav_burstcount
	wire          reset_button_s1_agent_rf_source_valid;                                              // reset_button_s1_agent:rf_source_valid -> reset_button_s1_agent_rsp_fifo:in_valid
	wire  [107:0] reset_button_s1_agent_rf_source_data;                                               // reset_button_s1_agent:rf_source_data -> reset_button_s1_agent_rsp_fifo:in_data
	wire          reset_button_s1_agent_rf_source_ready;                                              // reset_button_s1_agent_rsp_fifo:in_ready -> reset_button_s1_agent:rf_source_ready
	wire          reset_button_s1_agent_rf_source_startofpacket;                                      // reset_button_s1_agent:rf_source_startofpacket -> reset_button_s1_agent_rsp_fifo:in_startofpacket
	wire          reset_button_s1_agent_rf_source_endofpacket;                                        // reset_button_s1_agent:rf_source_endofpacket -> reset_button_s1_agent_rsp_fifo:in_endofpacket
	wire          reset_button_s1_agent_rsp_fifo_out_valid;                                           // reset_button_s1_agent_rsp_fifo:out_valid -> reset_button_s1_agent:rf_sink_valid
	wire  [107:0] reset_button_s1_agent_rsp_fifo_out_data;                                            // reset_button_s1_agent_rsp_fifo:out_data -> reset_button_s1_agent:rf_sink_data
	wire          reset_button_s1_agent_rsp_fifo_out_ready;                                           // reset_button_s1_agent:rf_sink_ready -> reset_button_s1_agent_rsp_fifo:out_ready
	wire          reset_button_s1_agent_rsp_fifo_out_startofpacket;                                   // reset_button_s1_agent_rsp_fifo:out_startofpacket -> reset_button_s1_agent:rf_sink_startofpacket
	wire          reset_button_s1_agent_rsp_fifo_out_endofpacket;                                     // reset_button_s1_agent_rsp_fifo:out_endofpacket -> reset_button_s1_agent:rf_sink_endofpacket
	wire          cmd_mux_006_src_valid;                                                              // cmd_mux_006:src_valid -> reset_button_s1_agent:cp_valid
	wire  [106:0] cmd_mux_006_src_data;                                                               // cmd_mux_006:src_data -> reset_button_s1_agent:cp_data
	wire          cmd_mux_006_src_ready;                                                              // reset_button_s1_agent:cp_ready -> cmd_mux_006:src_ready
	wire   [13:0] cmd_mux_006_src_channel;                                                            // cmd_mux_006:src_channel -> reset_button_s1_agent:cp_channel
	wire          cmd_mux_006_src_startofpacket;                                                      // cmd_mux_006:src_startofpacket -> reset_button_s1_agent:cp_startofpacket
	wire          cmd_mux_006_src_endofpacket;                                                        // cmd_mux_006:src_endofpacket -> reset_button_s1_agent:cp_endofpacket
	...
	wire   [13:0] cmd_mux_007_src_channel;                                                            // cmd_mux_007:src_channel -> accumulate_s1_agent:cp_channel
	...
	wire   [13:0] cmd_mux_009_src_channel;                                                            // cmd_mux_009:src_channel -> otg_hpi_w_s1_agent:cp_channel
	...
	wire   [13:0] cmd_mux_012_src_channel;                                                            // cmd_mux_012:src_channel -> otg_hpi_address_s1_agent:cp_channel
	...
	wire   [13:0] cmd_mux_013_src_channel;                                                            // cmd_mux_013:src_channel -> otg_hpi_cs_s1_agent:cp_channel
	...
	wire          reset_button_s1_agent_rp_valid;                                                     // reset_button_s1_agent:rp_valid -> router_008:sink_valid
	wire  [106:0] reset_button_s1_agent_rp_data;                                                      // reset_button_s1_agent:rp_data -> router_008:sink_data
	wire          reset_button_s1_agent_rp_ready;                                                     // router_008:sink_ready -> reset_button_s1_agent:rp_ready
	wire          reset_button_s1_agent_rp_startofpacket;                                             // reset_button_s1_agent:rp_startofpacket -> router_008:sink_startofpacket
	wire          reset_button_s1_agent_rp_endofpacket;                                               // reset_button_s1_agent:rp_endofpacket -> router_008:sink_endofpacket
	...
	wire          reset_button_s1_agent_rdata_fifo_src_valid;                                         // reset_button_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_006:in_0_valid
	wire   [33:0] reset_button_s1_agent_rdata_fifo_src_data;                                          // reset_button_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_006:in_0_data
	wire          reset_button_s1_agent_rdata_fifo_src_ready;                                         // avalon_st_adapter_006:in_0_ready -> reset_button_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_006_out_0_valid;                                                  // avalon_st_adapter_006:out_0_valid -> reset_button_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_006_out_0_data;                                                   // avalon_st_adapter_006:out_0_data -> reset_button_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_006_out_0_ready;                                                  // reset_button_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_006:out_0_ready
	wire    [0:0] avalon_st_adapter_006_out_0_error;                                                  // avalon_st_adapter_006:out_0_error -> reset_button_s1_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) reset_button_s1_translator (
		.clk                    (clk_0_clk_clk),                                    //                      clk.clk
		.reset                  (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (reset_button_s1_agent_m0_address),                 // avalon_universal_slave_0.address
		.uav_burstcount         (reset_button_s1_agent_m0_burstcount),              //                         .burstcount
		.uav_read               (reset_button_s1_agent_m0_read),                    //                         .read
		.uav_write              (reset_button_s1_agent_m0_write),                   //                         .write
		.uav_waitrequest        (reset_button_s1_agent_m0_waitrequest),             //                         .waitrequest
		.uav_readdatavalid      (reset_button_s1_agent_m0_readdatavalid),           //                         .readdatavalid
		.uav_byteenable         (reset_button_s1_agent_m0_byteenable),              //                         .byteenable
		.uav_readdata           (reset_button_s1_agent_m0_readdata),                //                         .readdata
		.uav_writedata          (reset_button_s1_agent_m0_writedata),               //                         .writedata
		.uav_lock               (reset_button_s1_agent_m0_lock),                    //                         .lock
		.uav_debugaccess        (reset_button_s1_agent_m0_debugaccess),             //                         .debugaccess
		.av_address             (reset_button_s1_address),                          //      avalon_anti_slave_0.address
		.av_readdata            (reset_button_s1_readdata),                         //                         .readdata
		.av_write               (),                                                 //              (terminated)
		.av_read                (),                                                 //              (terminated)
		.av_writedata           (),                                                 //              (terminated)
		.av_begintransfer       (),                                                 //              (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.USE_WRITERESPONSE         (0),
		.ECC_ENABLE                (0)
	) reset_button_s1_agent (
		.clk                     (clk_0_clk_clk),                                    //             clk.clk
		.reset                   (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), //       clk_reset.reset
		.m0_address              (reset_button_s1_agent_m0_address),                 //              m0.address
		.m0_burstcount           (reset_button_s1_agent_m0_burstcount),              //                .burstcount
		.m0_byteenable           (reset_button_s1_agent_m0_byteenable),              //                .byteenable
		.m0_debugaccess          (reset_button_s1_agent_m0_debugaccess),             //                .debugaccess
		.m0_lock                 (reset_button_s1_agent_m0_lock),                    //                .lock
		.m0_readdata             (reset_button_s1_agent_m0_readdata),                //                .readdata
		.m0_readdatavalid        (reset_button_s1_agent_m0_readdatavalid),           //                .readdatavalid
		.m0_read                 (reset_button_s1_agent_m0_read),                    //                .read
		.m0_waitrequest          (reset_button_s1_agent_m0_waitrequest),             //                .waitrequest
		.m0_writedata            (reset_button_s1_agent_m0_writedata),               //                .writedata
		.m0_write                (reset_button_s1_agent_m0_write),                   //                .write
		.rp_endofpacket          (reset_button_s1_agent_rp_endofpacket),             //              rp.endofpacket
		.rp_ready                (reset_button_s1_agent_rp_ready),                   //                .ready
		.rp_valid                (reset_button_s1_agent_rp_valid),                   //                .valid
		.rp_data                 (reset_button_s1_agent_rp_data),                    //                .data
		.rp_startofpacket        (reset_button_s1_agent_rp_startofpacket),           //                .startofpacket
		...
		.rf_sink_ready           (reset_button_s1_agent_rsp_fifo_out_ready),         //         rf_sink.ready
		.rf_sink_valid           (reset_button_s1_agent_rsp_fifo_out_valid),         //                .valid
		.rf_sink_startofpacket   (reset_button_s1_agent_rsp_fifo_out_startofpacket), //                .startofpacket
		.rf_sink_endofpacket     (reset_button_s1_agent_rsp_fifo_out_endofpacket),   //                .endofpacket
		.rf_sink_data            (reset_button_s1_agent_rsp_fifo_out_data),          //                .data
		.rf_source_ready         (reset_button_s1_agent_rf_source_ready),            //       rf_source.ready
		.rf_source_valid         (reset_button_s1_agent_rf_source_valid),            //                .valid
		.rf_source_startofpacket (reset_button_s1_agent_rf_source_startofpacket),    //                .startofpacket
		.rf_source_endofpacket   (reset_button_s1_agent_rf_source_endofpacket),      //                .endofpacket
		.rf_source_data          (reset_button_s1_agent_rf_source_data),             //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_006_out_0_ready),                // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_006_out_0_valid),                //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_006_out_0_data),                 //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_006_out_0_error),                //                .error
		.rdata_fifo_src_ready    (reset_button_s1_agent_rdata_fifo_src_ready),       //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (reset_button_s1_agent_rdata_fifo_src_valid),       //                .valid
		.rdata_fifo_src_data     (reset_button_s1_agent_rdata_fifo_src_data),        //                .data
		.m0_response             (2'b00),                                            //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                              //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) reset_button_s1_agent_rsp_fifo (
		.clk               (clk_0_clk_clk),                                    //       clk.clk
		.reset             (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
		.in_data           (reset_button_s1_agent_rf_source_data),             //        in.data
		.in_valid          (reset_button_s1_agent_rf_source_valid),            //          .valid
		.in_ready          (reset_button_s1_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (reset_button_s1_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (reset_button_s1_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (reset_button_s1_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (reset_button_s1_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (reset_button_s1_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (reset_button_s1_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (reset_button_s1_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                            // (terminated)
		.csr_read          (1'b0),                                             // (terminated)
		.csr_write         (1'b0),                                             // (terminated)
		.csr_readdata      (),                                                 // (terminated)
	...
	lab7_soc_mm_interconnect_0_router_002 router_008 (
		.sink_ready         (reset_button_s1_agent_rp_ready),                   //      sink.ready
		.sink_valid         (reset_button_s1_agent_rp_valid),                   //          .valid
		.sink_data          (reset_button_s1_agent_rp_data),                    //          .data
		.sink_startofpacket (reset_button_s1_agent_rp_startofpacket),           //          .startofpacket
		.sink_endofpacket   (reset_button_s1_agent_rp_endofpacket),             //          .endofpacket
		.clk                (clk_0_clk_clk),                                    //       clk.clk
		.reset              (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab7_soc_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                                    // in_clk_0.clk
		.in_rst_0_reset (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (reset_button_s1_agent_rdata_fifo_src_data),        //     in_0.data
		.in_0_valid     (reset_button_s1_agent_rdata_fifo_src_valid),       //         .valid
		.in_0_ready     (reset_button_s1_agent_rdata_fifo_src_ready),       //         .ready
